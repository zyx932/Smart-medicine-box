...
int main()
{
    ...
    int resultCount = 0; // Counter for the number of results printed
    ...
    while(1)
    {
        ...
        if (resultCount >= 3) // Check if we have printed three results
        {
            break; // Break out of the loop if we have printed three results
        }
    }
